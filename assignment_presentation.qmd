...
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| In **eruption** database, there is two noticable numberic column *vei* and year, month, day of starting and ending moment of each event. I will use those data to present on a graph.                                           | ![Volcanic Explosivity Index (VEI) volume graphn](images/500px-VEIfigure_en.svg.png){width="200"}                                                                |
|                                                                                                                                                                                                                                 |                                                                                                                                                                  |
  ...
  mutate(
    primary_volcano_type= str_replace_all(primary_volcano_type,
                                          fixed(c('Stratovolcano?' = 'Stratovolcano',
                                                  ...
                                                  'Complex(es)' = 'Complex'))))
unique(eruptions_2000s_3$primary_volcano_type)
```
...
unique(volcano_points2$primary_volcano_type)
